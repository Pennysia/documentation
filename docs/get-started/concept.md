...
We've compiled [evidence](https://github.com/Pennysia/cfmm-vs-clmm-lp-profitability) showing that the majority of concentrated liquidity positions on volatile assets fail to generate profit due to excessive impermanent loss and unsustainable yield mechanisms.
