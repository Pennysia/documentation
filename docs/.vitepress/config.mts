...
export default defineConfig({
  head: [
    ...
    ['meta', { property: 'og:title', content: 'Pennysia - Advanced AMM Protocol Documentation' }],
    ...
    ['meta', { name: 'twitter:title', content: 'Pennysia - Advanced AMM Protocol Documentation' }],
