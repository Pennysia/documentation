...
export default defineConfig({
  head: [
    ...
    ['meta', { property: 'og:image', content: 'https://docs.pennysia.com/readTheDocRainbow_Card.png' }],
    ...
    ['meta', { name: 'twitter:image', content: 'https://docs.pennysia.com/readTheDocRainbow_Card.png' }],
