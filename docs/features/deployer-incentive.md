...
Empowering builders and projects to launch new markets on Pennysia with automatic revenue sharing.

<img src="/deployer.svg" alt="deployer incentive">

## Purpose

This incentive aligns our growth with the success of its ecosystem partners. It encourages:

- Developers to create markets and sustain them.
