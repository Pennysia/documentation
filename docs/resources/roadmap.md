---
title: Roadmap
description: Where we are heading to and what's next for Pennysia.
lang: en-US
layout: doc
footer: true
lastUpdated: true
...
### 1.Ideation - Completed <span class="status-icon">✓</span>

This stage focused on validating the core concept and building the foundational technology.
...
We just entered this stage where we improved the product based on feedback collected from the ideation stage and make it ready to ship to public testnet and mainnet.

::: info :book: NOTE
We'll have the 1st fundraise in this stage to support the development and launch.
:::

This step include the following orders:

- Public testnet launch
- Smart contract security audit
- UX refinement and scalable infrastructure
...
Targeting to scale the user base and expand the product features.
